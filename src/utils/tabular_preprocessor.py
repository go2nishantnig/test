"""
Tabular data preprocessor for fraud detection.

This module provides the FraudDataPreprocessor class for processing
transaction data from the Online Payments Fraud Detection dataset.
"""
import numpy as np
import pandas as pd
...
class FraudDataPreprocessor:
    """
    Preprocessor for Tabular Fraud Detection Data
    
    Handles preprocessing of transaction data from the Online Payments
    Fraud Detection Dataset format.
